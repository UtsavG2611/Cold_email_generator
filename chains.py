...
# In production, environment variables should be set in the Render dashboard
load_dotenv()
...
class Chain:
    ...
    def write_email(self, job_description, portfolio_urls):
        prompt_email = PromptTemplate.from_template(
                ...
                Your Role: Your name is Utsav, You are an incredible business development officer who knows how to get clients. You work for Mentee Consulting firm, your firm works with all sorts of IT clients and provide solutions in the domain of Data Science and AI. 
                ...
                do not include if any This email aims to and Based on the job description and portfolio URLs provided part.
